...
@section('content')
    <div class="flex justify-between mb-3">
        ...
        <x-toolbar backRoute="admin.posts.index" />
    </div>
                ...
                @else
                    @foreach ($posts as $post)
                        <tr>
                            ...
                            <td class="whitespace-nowrap max-w-96 overflow-hidden text-ellipsis">
                                {{ $post->content }}
                            </td>
                            <td>
                            ...
                            <td>
                                <x-action-buttons type="trash" :id="$post->id" :name="$post->title" routeName="posts" />
                            </td>
                        </tr>
                    @endforeach
                @endif
